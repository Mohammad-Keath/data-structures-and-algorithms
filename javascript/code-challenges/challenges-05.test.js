...
const addValues = (arr) => {
    return arr.reduce((summation,value)=>{
...
const addPurchases = (arr) => {
   return arr.reduce((purshed,value)=>{
    return purshed+= value.purchasePrice
   },0)
};
...
const countNumberOfElements = (arr) => {
  return arr.reduce((elNumbers,value)=>{
    return elNumbers+=1
  },0)
};
...
const returnNames = (arr) => {
  return arr.reduce((namesArr,value)=>{
