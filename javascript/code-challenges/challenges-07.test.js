...
const listFoods = (recipe) => {
  ...
  for(let i=0;i<recipe.ingredients.length;i++){
    if (recipe.ingredients[i].includes('sized')){
      result.push(recipe.ingredients[i].slice(-recipe.ingredients[i].lastIndexOf("sized")+1,recipe.ingredients[i].length))
      // result.push(recipe.ingredients[i])
  } else if (recipe.ingredients[i].includes('pounds')){
    result.push(recipe.ingredients[i].slice(recipe.ingredients[i].lastIndexOf("ounds")+6,recipe.ingredients[i].length))
   } else if (recipe.ingredients[i].includes('gallons')){
    result.push(recipe.ingredients[i].slice(recipe.ingredients[i].lastIndexOf("allons")+7,recipe.ingredients[i].length))
   } else if (recipe.ingredients[i].includes('pound')){
    result.push(recipe.ingredients[i].slice(recipe.ingredients[i].lastIndexOf("ound")+5,recipe.ingredients[i].length))
   } else if (recipe.ingredients[i].includes('cups')){
    result.push(recipe.ingredients[i].slice(recipe.ingredients[i].lastIndexOf("ups")+4,recipe.ingredients[i].length))
   }}
  return result;
;
}
